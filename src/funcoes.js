...
function truncar() { 
    ...
    let tamanho = 10 ;
    let palavraFinal="";
    if(palavra.length>= tamanho + 3){
        palavraFinal = palavra.substring(0,tamanho).concat("...");
    }
